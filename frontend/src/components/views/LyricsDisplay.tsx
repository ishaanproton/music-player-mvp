    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto" ref={scrollRef}>
                <div className="max-w-2xl mx-auto text-center space-y-6 sm:space-y-10 pt-16 sm:pt-24 pb-48 px-4 sm:px-8">
                            ...
                            >
                                {words.map((word, wordIdx) => {
                                    ...
                                    return (
                                        <span
                                            key={wordIdx}
                                            className={`text-xl sm:text-3xl md:text-4xl font-black tracking-tight transition-colors duration-200
                                                ${wordLit
