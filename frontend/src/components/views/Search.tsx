...
export const Search = () => {
    ...
    return (
        <div className="h-full flex flex-col p-4 sm:p-6 overflow-y-auto">
            <div className="sticky top-0 bg-surface/80 backdrop-blur-md z-10 -mx-4 sm:-mx-6 px-4 sm:px-6 pb-4 pt-2">
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-6">
                        {[
                            ...
                            <div 
                                key={i} 
                                className={`aspect-square rounded-xl p-3 sm:p-4 font-bold text-lg sm:text-xl relative overflow-hidden shadow-lg cursor-pointer hover:scale-105 transition-transform bg-gradient-to-br ${genre.color}`}
                            >
