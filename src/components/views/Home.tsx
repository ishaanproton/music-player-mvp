...
export const Home = () => {
    ...
    return (
        <div className="h-full overflow-y-auto p-8 bg-gradient-to-b from-surfaceHover/30 to-surface pb-32">
            <h1 className="text-3xl font-black text-white mb-8 tracking-tight">{greeting}</h1>
            
            {quickPicks.length > 0 && (
                <section className="mb-12">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex flex-col">
                            <h2 className="text-3xl font-black text-white tracking-tight">Quick picks</h2>
                        </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                    {GENRES.map((genre, i) => (
                        <div 
                            ...
                            className={`aspect-square rounded-xl p-4 font-bold text-2xl relative overflow-hidden shadow-2xl cursor-pointer hover:scale-[1.02] active:scale-95 transition-all bg-gradient-to-br ${genre.color} ${loadingAction === genre.name ? 'opacity-50' : ''}`}
                        >
            ...
            {/* Creator Footer */}
            <footer className="mt-16 pb-8 border-t border-white/10 pt-8 flex flex-col items-center justify-center text-center text-textSecondary">
                <p className="text-sm font-bold tracking-widest text-white mb-2 uppercase">Created by Ishaan Kumar</p>
                <p className="text-xs font-medium bg-surfaceHover px-3 py-1 rounded-full shadow-inner inline-flex items-center gap-2">
