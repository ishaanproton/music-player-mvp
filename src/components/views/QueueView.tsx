...
export const QueueView = () => {
    ...
    return (
        <div className="h-full overflow-y-auto p-8 bg-gradient-to-b from-surfaceHover/20 to-surface pb-32 scrollbar-hide">
            <h1 className="text-4xl font-black text-white mb-8 tracking-tighter">Queue</h1>
